...
app.get("/jokes/:id",(req,res)=>{
  ...
  if(joke)
  {
    ...
    res.status(404).json({error:"this is some error"})
  }
})
...
app.get("/filter",(req,res)=>{
  ...
  if(jokeType)
  {
    const filterJoke=jokes.filter(joke=>joke.jokeType.toLowerCase()==jokeType.toLowerCase())
    ...
    res.status(404).json({error:"no such filter"})
  }
...
app.put("/jokes/:id",(req,res)=>{
  ...
  const searchIndex =jokes.findIndex((joke)=>joke.id===joke)
...
app.delete("/jokes/:id",(req,res)=>{
  ...
  if(jokeIndex !==-1)
  {
    ...
    res.json({message:'Joke delted successfully'})
  }else{
